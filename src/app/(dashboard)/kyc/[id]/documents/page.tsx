    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href={`/kyc/${userId}`} className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">View and manage verification documents</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className="font-medium text-gray-900">{documents.length} file(s)</div>
              </div>
            </div>
            <Link href={`/kyc/${userId}`} className="text-sm text-primary hover:text-primary-hover font-medium">
              View Full Profile →
            </Link>
          </div>
        </div>
                  ...
                  return docId ? (
                    ...
                    >
                      ...
                      <div className="relative bg-gray-50 h-48 flex items-center justify-center">
                        ...
                        {doc.verified && (
                          <div className="absolute top-2 right-2 bg-success text-white text-xs font-medium px-2 py-1 rounded-full">
                            Verified
                          </div>
                        )}
                      </div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center p-2 text-error bg-white border border-gray-200 rounded-lg hover:bg-error-light transition-colors"
                          >
            ...
            {selectedDocument.ocrData && (
              <div className="p-4 border-t border-gray-200 bg-white">
                ...
                {selectedDocument.ocrData.mismatches && selectedDocument.ocrData.mismatches.length > 0 && (
                  <div className="mt-4 p-3 bg-error-light border border-error rounded">
                    <div className="font-medium text-error mb-2">⚠ Data Mismatches Found:</div>
